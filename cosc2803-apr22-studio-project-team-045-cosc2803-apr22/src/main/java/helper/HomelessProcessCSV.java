...
public class HomelessProcessCSV {
   ...
   private static final String CSV_FILE = "database/population-2018Revised.csv";
   ...
   public static void main (String[] args) {
      ...
      try {
         ...
         while (lineScanner.hasNext()) {
            ...
            while (rowScanner.hasNext()) { //&& indexStatus < ageCategory.length) {
               ...
               String query = "INSERT into LGAStatistics VALUES ("
                              + lgaCode + ","
                              + "'" + year + "',"
                              + count + ")";
